...
export function AdminInterface({ userProfile }: AdminInterfaceProps) {
  const pathname = usePathname();
  const [currentPage, setCurrentPage] = useState("Administración de Vouchers");

  const menuItems = getMenuForRole("admin");
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {[1, 2, 3, 4, 5].map((i) => (
                    <tr key={i} className="border-b">
                      <td className="px-4 py-2">P-{1000 + i}</td>
                      <td className="px-4 py-2">Socio {i}</td>
                      <td className="px-4 py-2">socio{i}@example.com</td>
                      <td className="px-4 py-2">
                        {new Date().toLocaleDateString()}
                      </td>
                      <td className="px-4 py-2">
