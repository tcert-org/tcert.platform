...
export type FilterParamsPartner = {
  ...
  filter_expired_vouchers?: number;
  filter_expired_vouchers_op?: string;
  order_by?: string;
  order_dir?: "asc" | "desc";
  page?: number;
  limit_value?: number;
  ...
  try {
    ...
    const params: FilterParamsPartner = {
      ...
      filter_expired_vouchers_op:
        searchParams.get("filter_expired_vouchers_op") || "=",
      filter_expired_vouchers: searchParams.get("filter_expired_vouchers")
        ? parseInt(searchParams.get("filter_expired_vouchers")!)
        : undefined,
